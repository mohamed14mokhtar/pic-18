...
void MSSP_I2C_Master_read_data_in_register(const mssp_i2c_t *i2c_obj, uint8 i2c_data_1, uint8 i2c_data_2,uint8 *ret_data,uint8 *_ack){
    ...
    if((NULL == i2c_obj) || (NULL == _ack)){
        ret = E_not_ok;
         ...
         MSSP_I2C_Master_Write_Blocking(i2c_obj,i2c_data_1,_ack);   
         MSSP_I2C_Master_Write_Blocking(i2c_obj,i2c_data_2,_ack);
         MSSP_I2C_Master_Send_Repeated_Start(i2c_obj);
         MSSP_I2C_Master_Write_Blocking(i2c_obj,(i2c_data_1 + 0x01),_ack);
         MSSP_I2C_Master_Read_Blocking(i2c_obj,I2C_MASTER_SEND_NACK,ret_data);
...
static inline void MSSP_I2C_Interrupt_Configurations(const mssp_i2c_t *i2c_obj){
#if MSSP_I2C_INTERRUPT_feature_ENABLE == INTERRUPT_FATURE_ENABLE
...
/* Interrupt Priority Configurations */
        ...
        if(INTERRUPT_HUGH_PRIORITY == i2c_obj->i2c_cfg.mssp_i2c_priority){
        ...
        if(INTERRUPT_HUGH_PRIORITY == i2c_obj->i2c_cfg.mssp_i2c_bc_priority){
            /* Enables all high-priority interrupts */
            INTERRUPT_globalinterrupthighenable();
...
/*
 ...
 void mssp_I2C_DefaultInterruptHandler(void){
    ...
    if((SSPSTATbits.D_nA) && (SSPSTATbits.R_NOT_W)){
        ...
        while(!SSPSTATbits.BF);
        ret_i2c_data_2 =SSPBUF;
    }
    holds clock high (clock stretch) 
